...
<?php 
   $footer_v4_to_top =& $teba_options["tb_footer_v4_to_top"]; ?>
   <a href="#" id="back-to-top" class="progress <?php if($footer_v4_to_top == 0){ echo "hide_icon"; }?> "><div class="arrow-top"></div>
      <svg class="progress-circle svg-content" width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="xMinYMin meet"><path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98"/></svg>
   </a>

<?php $footer_v4_fixed =& $teba_options["tb_footer_v4_fixed"]; ?>
<footer class="footer footer_v4 <?php if($footer_v4_fixed == 1){ echo "footer-fixed"; }?>"> 
   <div class="container">
      ...
      <?php if (is_active_sidebar("teba-footer-widget-5")) { ?>
         <div class="footer-widget-5 col-sm-2 col-xs-12">
