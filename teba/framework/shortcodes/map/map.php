<?php
function teba_maps_render($params) {
	...
	wp_enqueue_script('teba-maps-api', TEBA_URI_PATH_FR . "/shortcodes/map/maps.js",array(),'1.0.0');
    /* Map Style defualt */
    $map_styles = array(
...
if(function_exists('teba_shortcode')) { teba_shortcode('maps', 'teba_maps_render'); }