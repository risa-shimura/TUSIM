<div class="thumb-service">
	...
	if($attachment_image[0]) { echo '<img src="'.esc_url($attachment_image[0]).'" alt="'.esc_attr($title_box).'"/>';} ?>
</div>
<div class="title-wrap">
  <?php
	...
	if($href !== '') echo '<div class="center"><a class="button btn-txt btn-txt-underlined dark" href="'.esc_url($href).'" target="'. esc_attr($target).'"><span class="button-text">'. esc_html($txt_link_box) .'</span> <span class="button-arrow"><span class="button-icon"></span></span></a></div>';
  ?>
 </div>