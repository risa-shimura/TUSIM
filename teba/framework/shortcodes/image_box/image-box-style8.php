...
<div class="title-wrap">
  <?php    
	   ...
	   if($href !== '') echo '<a class="button btn-txt btn-txt-arrow dark" href="'.esc_url($href).'" target="'. esc_attr($target).'"><span class="button-text">'. esc_html($txt_link_box) .'</span> <span class="button-arrow"><span class="button-icon"></span></span></a>';
	?>
 </div>